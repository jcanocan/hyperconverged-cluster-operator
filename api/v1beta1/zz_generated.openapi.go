		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"tuning": {
						SchemaProps: spec.SchemaProps{
							Description: "tuning HyperConvergedConfig influences KubeVirt qps and burst parameters.",
							Ref:         ref("github.com/kubevirt/hyperconverged-cluster-operator/api/v1beta1.Tuning"),
						},
					},
					"infra": {
						SchemaProps: spec.SchemaProps{
